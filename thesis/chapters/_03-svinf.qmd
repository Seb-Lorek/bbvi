...
![ELBO traces for 3 different SGD runs, using different variational sample sizes. Using batch VI with a learning rate of 1e-2 and the same seed as in @fig-elbo-trace1.](assets/plots/plot4.pdf){fig-scap="ELBO traces for different variational sample sizes." #fig-elbo-trace3}
